...
<details class="acc">
<summary><span class="acc-toggle"></span><span class="acc-title">Hauptfiguren einblenden und Namen per Hover erkunden</span><span class="acc-tag tag-ux">Interaktionsdesign</span></summary>
<div class="acc-body">
<p>Über den Button können die Hauptfiguren ein- und ausgeblendet werden. Beim Hovern erscheint ein Tooltip mit dem Namen der Figur, sodass die zufällige Verteilung direkt zu erkennen ist.</p>
...
In der folgenden Animation ist das Verhalten der Kräfte sichtbar. Versuche die Knoten näher aneinander zu bringen und entdecke was passiert.
<div id="graph-step3"></div>

<p style="text-align:left; font-size:12px; color:#888; margin:8px 0 16px;">
  Abbildung: Animierte Darstellung der physischen Kräfte.
</p>

<details class="acc">
<summary><span class="acc-toggle"></span><span class="acc-title">Knoten per Drag verschieben und Kräfte direkt beobachten</span><span class="acc-tag tag-ux">Interaktionsdesign</span></summary>
<div class="acc-body">
<p>Die Knoten lassen sich greifen und verschieben. Das Netzwerk reagiert sofort auf Anziehungs- und Abstoßungskräfte, sodass die physikalischen Kräfte des Force-Directed Layouts unmittelbar erfahrbar sind.</p>
</div>
</details>
...
<details class="acc">
<summary><span class="acc-toggle"></span><span class="acc-title">Hauptfiguren umschalten und Namen im Gesamtnetzwerk prüfen</span><span class="acc-tag tag-ux">Interaktionsdesign</span></summary>
<div class="acc-body">
<p>Die vollständige Netzwerkstruktur wird als Force-Simulation dargestellt. Über den Toggle lassen sich die Hauptfiguren hervorheben, und per Hover können einzelne Knoten identifiziert werden.</p>
</div>
</details>
...
<details class="acc">
<summary><span class="acc-toggle"></span><span class="acc-title">Communities farblich lesen und Nachbarschaften per Hover hervorheben</span><span class="acc-tag tag-ux">Interaktionsdesign</span></summary>
<div class="acc-body">
<p>Farben markieren soziale Gruppen innerhalb des Netzwerks. Beim Hover über einen Knoten werden seine direkten Verbindungen hervorgehoben und nicht relevante Elemente abgeschwächt, wodurch lokale Nachbarschaften und zentrale Figuren leichter erkennbar werden.</p>
</div>
</details>
...
<details class="acc">
<summary><span class="acc-toggle"></span><span class="acc-title">Netzwerkgröße anpassen</span><span class="acc-tag tag-ux">Interaktionsdesign</span></summary>
<div class="acc-body">
<p>Mit den Plus- und Minus-Buttons lässt sich die Größe des Netzwerks verändern. So kann interaktiv beobachtet werden, ab wann die Darstellung unübersichtlich wird und die Leistung schwächer wird.</p>
</div>
</details>
